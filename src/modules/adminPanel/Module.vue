<template>
   <div class="int-admin" :class="{'int-admin-wide': isOpen == false, 'int-admin-normal': isOpen == true }">
      <sidebar :class="{'sidebar-close': isOpen == false, 'sidebar-open': isOpen == true }" />
            ...
            <div class="collapse navbar-collapse" id="navCollapse">
               ...
               <ul class="navbar-nav justify-self-start">
                  ...
                  <!-- <li class="nav-item hover-item rounded">
                     <router-link class="nav-link router-link-exact-active router-link-active" to="/" exact>{{$t('nav.dashboard')}}</router-link>
                  </li> -->
                  ...
                  <li class="nav-item hover-item">
                     <router-link id="v-step-1" class="nav-link rounded tracking-icon mr-3" to="/rout-track">{{$t('nav.rout_track')}}</router-link>
                  </li>
               </ul>
