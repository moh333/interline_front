                  ...
                  <div class="container">
                     <div class="row">
                        <div class="col-xl-7 col-lg-6 my-4 align-self-end">
                           <h1 class="h1 text-white-heading mb-4">INTERLINE Minivans</h1>
                           <p class="f3 text-white-content">Find out more about our minivan fleet here. We have a whole range of fully equipped, comfortable vehicles tailored to your needs.</p>
                        </div>
                     </div>
                  </div>
               </template>
...
export default {
	...
	mounted() {
		this.$store.dispatch("loadMinivanssVehicles");
	}
};
</script>
