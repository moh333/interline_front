         ...
         <template #content>
            <overlay-card :has-background="true" background-type="gradient" :has-content="true" content-aling="end" :image="image" height="600">
               <template #content>
                  <div class="container">
                     <div class="row">
                        <div class="col-xl-7 col-lg-6 my-4 align-self-end">
                           <h1 class="h1 text-white-heading mb-4">INTERLINE Limousines</h1>
                           <p class="f3 text-white-content">We offer luxury and extremely comfortable limousines that cater for all tastes and requirements. Just pick the vehicle that suits your needs from our modern fleet of limousines.</p>
                        </div>
                     </div>
                  </div>
               </template>
...
export default {
	...
	mounted() {
		this.$store.dispatch("loadLimousinesVehicles");
	}
};
</script>
